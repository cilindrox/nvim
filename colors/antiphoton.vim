...
if ($TERM =~ '256' || &t_Co >= 256) || has('gui_running')
    ...
    hi Comment ctermbg=bg ctermfg=246 cterm=italic guibg=bg guifg=#949494 gui=italic
    ...
    hi LineNr ctermbg=NONE ctermfg=246 cterm=NONE guibg=#eeeeee guifg=#949494 gui=NONE
    hi CursorLineNr ctermbg=255 ctermfg=134 cterm=bold guibg=#eeeeee guifg=#6c6c6c gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
    ...
    hi CursorLineNr ctermbg=white ctermfg=darkgray cterm=bold
